...
- **Phase 7** — P7-1 *part 2* (fold the FTS-else-LIKE search *bodies* into `retrieval.py` — changes search results, wants live verification), P7-2 persona-worker spec table, P7-3 agent-adapter base, P7-4 status SSOT, P7-6 cards_api split, P7-7 feed-page extraction, P7-8 learn drivers, P7-9 oauth dead code, P7-10 rust process_util. Each a focused, behavior-preserving refactor best done one-per-PR against the suite.
