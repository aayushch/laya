...
Remaining: (a) two feed items (P4-9/10) that want browser-driven verification + a product call (all-days feed shape; substring→token search semantics), (b) the big structural splits (P7-6/7), (c) the deferred P7-8 driver/consolidation half and the P6 prompt program.
