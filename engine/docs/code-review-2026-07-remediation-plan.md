...
- **Phase 4** — P4-24 composer `/egress/execute` dedup (core covered by P3-8); P4-26 (WS `send_input` no-op — the workspace agent-answer flow, wants agent-driven verification).
...
Remaining: (a) the big structural splits (P7-6/7), (b) the deferred P7-8 driver/consolidation half, (c) the P6 prompt-reduction program (needs a golden-output harness first), and the two small verification-gated leftovers P4-24/P4-26.
