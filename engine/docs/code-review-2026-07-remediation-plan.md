...
Remaining: (a) the `feed/+page.svelte` split (P7-7), (b) the deferred P7-8 driver/consolidation half, (c) the P6 prompt-reduction program (needs a golden-output harness first), and the small P4-24 (composer dedup; core already covered by P3-8).
