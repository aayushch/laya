...
Remaining: (a) three riskier/UI-coupled engine items (P4-9/10/12) that want browser-driven verification of the feed, (b) the big structural splits (P7-6/7), (c) the deferred P7-8 driver/consolidation half and the P6 prompt program.
